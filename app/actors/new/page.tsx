...
export default function NewActorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push('/actors?success=created')
      } else {
    ...
    <ProtectedLayout>
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Criar Novo Actor</h1>
          <p className="mt-2 text-gray-600">
            Preencha os dados abaixo para criar um novo actor no sistema
          </p>
        </div>
