...
import { ArrowLeft, Save, AlertCircle, Loader2, Building2 } from 'lucide-react'
...
export default function EditDistrictPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    Promise.all([fetchDistrict(), fetchProvinces()])
  }, [params.id])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push('/locations?success=updated&type=district')
      } else {
        const data = await response.json()
      ...
      <ProtectedLayout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-600">A carregar distrito...</p>
          </div>
        </div>
      </ProtectedLayout>
    )
      ...
      <ProtectedLayout>
        <div className="max-w-2xl mx-auto p-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            ...
            <h2 className="text-lg font-semibold text-red-800 mb-2">Erro ao carregar distrito</h2>
      ...
      <div className="max-w-2xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Editar Distrito</h1>
              <p className="mt-1 text-gray-600">
                Actualize os dados do distrito
              </p>
            </div>
          </div>
        </div>
